...
from model.hkudetector import resnet101
...
parser.add_argument('--num_epochs', default=48, type=int, help='number of epochs')
...
parser.add_argument('--load_pretrain', default='./weights/resnet101.pth', type=str, help='pretrain weight')
...
parser.add_argument('--output_dir', default='./logs/resnet101', type=str, help='output directory')
...
if __name__ == '__main__':
    ...
    # ============================ step 2/5 模  型 ============================
    hku_mmdetector = resnet101(args=args)
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (images, target) in progress_bar:
            ...
            cudamemory = sum([torch.cuda.memory_reserved(i) for i in range(torch.cuda.device_count())])
            mem = '%.3gG' % (cudamemory / 1E9 if torch.cuda.is_available() else 0)
