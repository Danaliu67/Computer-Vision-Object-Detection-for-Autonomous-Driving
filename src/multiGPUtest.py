...
parser.add_argument('--output_dir', default='./logs/resnet50_640', type=str, help='output directory')
...
if __name__ == '__main__':
    ...
    hku_mmdetector = torch.nn.SyncBatchNorm.convert_sync_batchnorm(hku_mmdetector).to(device)
