...
from model.hkudetector import resnet34
...
parser.add_argument('--load_pretrain', default='./weights/resnet34.pth', type=str, help='pretrain weight')
...
parser.add_argument('--output_dir', default='./logs/resnet34', type=str, help='output directory')
...
if __name__ == '__main__':
    ...
    # ============================ step 2/5 模  型 ============================
    hku_mmdetector = resnet34(args=args)
